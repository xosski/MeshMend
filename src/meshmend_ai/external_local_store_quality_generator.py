...
def main() -> int:
    ...
    final = {
        ...
        "capability_tier": "experimental_procedural_native_sculpt",
        ...
        "store_quality_blockers": [
            "procedural/native geometry is not a learned studio sculpt backend",
            "automated mesh metrics and metadata tags cannot certify visual studio quality",
        ],
        "workflow": workflow,
...
def run_local_meshmend_sculpt_external(
    ...
    *,
    ...
    return {
        ...
        "store_quality_blockers": [
            "procedural/native geometry is not a learned studio sculpt backend",
            "automated topology/detail checks do not constitute visual studio-quality certification",
        ],
        "workflow": workflow,
        ...
        "mesh_info": {
            ...
            "printable_topology_ready": bool(assembly.quality_report.passed),
